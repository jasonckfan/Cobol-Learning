...
#### [Lesson 6-1：CLM 利息計算引擎剖析](lessons/lesson-6-1-clm-interest-engine.md) ✅

| 章節 | 內容 |
|------|------|
| Tier/Slab/Hybrid 利率結構 | 多層次利率計算 |
| 利息計算引擎架構 | 核心計算邏輯 |

#### [Lesson 6-2：CLM 利率覆蓋機制](lessons/lesson-6-2-clm-pricing-override.md) ✅

| 章節 | 內容 |
|------|------|
| Pricing Override 概念 | 利率覆蓋邏輯 |
| 例外利率管理 | 特殊利率處理 |

#### [Lesson 6-3：CLM 批次重啟與容錯機制](lessons/lesson-6-3-clm-batch-restart.md) ✅

| 章節 | 內容 |
|------|------|
| 批次失敗場景 | 常見錯誤分析 |
| Restart/Checkpoint 設計 | 重啟機制實現 |

#### [Lesson 6-4：CLM 多貨幣處理 (MCN)](lessons/lesson-6-4-clm-mcn.md) ✅
